...
?>
<div class="container"><div class="right_col" role="main">
    <!-- top tiles -->
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h1 class="page-header">Request Event Form</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    Fillup the form to Request An Event
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <form action="view/font/store2.php" method="POST" enctype="multipart/form-data">
