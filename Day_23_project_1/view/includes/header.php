...
<head>
    ...
    <base href="http://localhost/P9/PHP63/Day_23_project_1/">
    <!-- Bootstrap Core CSS -->
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="view/student/create.php">Add</a>
                            </li>
                            <li>
                                <a href="view/student/index.php">View</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-user fa-fw"></i> Trainer<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="view/trainer/create.php">Add</a>
                            </li>
                            <li>
                                <a href="view/trainer/index.php">View</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-book fa-fw"></i> Assign<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
